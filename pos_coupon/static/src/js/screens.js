odoo.define("pos_coupon.screens", function(require) {
    ...
    const ScreenWidget = screens.OrderWidget;
    const PaymentScreenWidget = screens.PaymentScreenWidget;
    const ProductScreenWidget = screens.ProductScreenWidget;
    const ClientListScreenWidget = screens.ClientListScreenWidget;
    const ScaleScreenWidget = screens.ScaleScreenWidget;
    const OrderWidget = screens.OrderWidget;
    ...
    ScreenWidget.include(BarcodeCouponMixin);
    ProductScreenWidget.include(BarcodeCouponMixin);
    PaymentScreenWidget.include(BarcodeCouponMixin);
    ClientListScreenWidget.include(BarcodeCouponMixin);
    ScaleScreenWidget.include(BarcodeCouponMixin);
