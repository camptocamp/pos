...
odoo.define("pos_coupon.tour.pos_coupon1", function(require) {
    ...
    ProductScreen.exec.addOrderline("Magnetic Board", "9"); // 1.98
    ...
    PosCoupon.check.orderTotalIs("50.54");
    PosCoupon.do.enterCode("promocode");
    PosCoupon.check.hasRewardLine("50.0% discount on products", "-16.56");
    PosCoupon.check.orderTotalIs("33.98");
    PosCoupon.exec.finalizeOrder("Cash", "50");
