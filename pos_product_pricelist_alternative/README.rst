...
POS product pricelist allternative is based on the same logic of `OCA/product_pricelist_alternative: <https://github.com/OCA/product-attribute/tree/16.0/product_pricelist_alternative>`_  which allows you to define alternative price lists to a reference price list.
